...
const Summary = () => {
    ...
    const { previousScreen, componentName, deviceName, start_time, end_time, code, selectedDevice } = location.state
    ...
    const dashboardUrls = {
        summary: `http://192.168.0.224:3000/yantra/d/eda91bdc-b024-47f8-8852-cb6eff0627ed/summary-1?orgId=1&var-from=${start_time}&var-to=${end_time}&var-device_id=${deviceId}&var-device_name=${deviceName}&var-token=${newToken}&var-url=${baseUrl}&theme=light&kiosk`,
    ...
    const summarySubDashboards = [
        {
            label: "OEE",
            value: "oee",
            url: `http://192.168.0.224:3000/yantra/d/eda91bdc-b024-47f8-8852-cb6eff0627ed/summary-1?orgId=1&var-from=${start_time}&var-to=${end_time}&var-device_id=${deviceId}&var-device_name=${deviceName}&var-token=${newToken}&var-url=${baseUrl}&theme=light&kiosk`,
        },
        {
            label: "Parts Goal",
            value: "parts_goal",
