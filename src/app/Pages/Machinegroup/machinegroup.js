...
const handleDeleteMachineGroup = async (group) => {
  try {
    ...
    // 🔹 Step 4: Ask for deletion confirmation
    ...
    if (!confirm.isConfirmed) return; // No popup on cancel
